...
public:
	...
	//void processFrame(const cv::Mat& img1, const cv::Mat& img2, const cv::Mat& img3, BoundingBox& bbnext,
		//bool& lastboxfound, bool tl, FILE* bb_file);
	void processFrame(const cv::Mat& img1, const cv::Mat& img2, const cv::Mat& img3, BoundingBox& bbnext,
		bool& lastboxfound, bool tl, FILE* bb_file,MeanShift & ms);

	//void track(const cv::Mat& img1, const cv::Mat& img2, std::vector<cv::Point2f>& points1, std::vector<cv::Point2f>& points2);
	//add new way
	//void track(const Mat& img3);
	void track(const Mat& img3,MeanShift & ms);
